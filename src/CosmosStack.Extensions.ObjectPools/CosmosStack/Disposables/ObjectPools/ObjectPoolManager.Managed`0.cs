...
using Opt = CosmosStack.Disposables.ObjectPools.ObjectPoolManager.NonGeneric.ManagedModelOpt;
...
namespace CosmosStack.Disposables.ObjectPools
{
    ...
    public static partial class ObjectPoolManager
    {
        ...
        public static class NonGeneric
        {
            ...
            /// <returns></returns>
            public static Opt Managed(Type managedModelType) => new(managedModelType);
            ...
            public static Opt Managed<TManagedModel>() where TManagedModel : class, IObjectPoolManagedModel => new(typeof(TManagedModel));
    ...
    public static class ObjectPoolManagerNonGenericExtensions
    {
        ...
        // ReSharper disable once MemberHidesStaticFromOuterClass
        public static IObjectPayloadPool Get(this Opt opt, Type type)
        ...
        public static IObjectPayloadPool Get(this Opt opt, Type type, string name)
        ...
        /// <param name="opt"></param>
        /// <returns></returns>
        public static IObjectPayloadPool Create<T>(this Opt opt, int poolSize, Func<object> createObjectFunc, Action<ObjectPayload> getObjectHandler = null)
        ...
        /// <param name="opt"></param>
        /// <returns></returns>
        public static IObjectPayloadPool Create<T>(this Opt opt, string name, int poolSize, Func<object> createObjectFunc, Action<ObjectPayload> getObjectHandler = null)
        ...
        /// <param name="opt"></param>
        /// <returns></returns>
        public static IObjectPayloadPool Create(this Opt opt, Type type, int poolSize, Func<object> createObjectFunc, Action<ObjectPayload> getObjectHandler = null)
        ...
        /// <param name="opt"></param>
        /// <returns></returns>
        public static IObjectPayloadPool Create(this Opt opt, Type type, string name, int poolSize, Func<object> createObjectFunc, Action<ObjectPayload> getObjectHandler = null)
        ...
        /// <returns></returns>
        public static IObjectPayloadPool Create(this Opt opt, IPolicy policy)
        ...
        /// <returns></returns>
        public static IObjectPayloadPool Create(this Opt opt, IObjectPayloadPool pool)
        ...
        /// <returns></returns>
        public static IObjectPayloadPool Create(this Opt opt, Func<IObjectPayloadPool> poolFunc)
        ...
        /// <param name="policy"></param>
        /// <returns></returns>
        public static IObjectPayloadPool Create(this Opt opt, string name, IPolicy policy)
        ...
        /// <param name="pool"></param>
        /// <returns></returns>
        public static IObjectPayloadPool Create(this Opt opt, string name, IObjectPayloadPool pool)
        ...
        /// <param name="poolFunc"></param>
        /// <returns></returns>
        public static IObjectPayloadPool Create(this Opt opt, string name, Func<IObjectPayloadPool> poolFunc)
        ...
        /// <returns></returns>
        // ReSharper disable once MemberHidesStaticFromOuterClass
        public static IObjectPayloadPool GetOrCreate(this Opt opt, Type type, int poolSize, Func<object> createObjectFunc, Action<ObjectPayload> getObjectHandler = null)
        ...
        /// <returns></returns>
        // ReSharper disable once MemberHidesStaticFromOuterClass
        public static IObjectPayloadPool GetOrCreate(this Opt opt, Type type, IPolicy policy)
        ...
        // ReSharper disable once MemberHidesStaticFromOuterClass
        public static IObjectPayloadPool GetOrCreate(this Opt opt, Type type, Func<IObjectPayloadPool> insteadOfFactory)
        ...
        /// <returns></returns>
        // ReSharper disable once MemberHidesStaticFromOuterClass
        public static IObjectPayloadPool GetOrCreate(this Opt opt, Type type, string name, int poolSize, Func<object> createObjectFunc, Action<ObjectPayload> getObjectHandler = null)
        ...
        /// <returns></returns>
        // ReSharper disable once MemberHidesStaticFromOuterClass
        public static IObjectPayloadPool GetOrCreate(this Opt opt, Type type, string name, IPolicy policy)
        ...
        /// <exception cref="ArgumentNullException"></exception>
        // ReSharper disable once MemberHidesStaticFromOuterClass
        public static IObjectPayloadPool GetOrCreate(this Opt opt, Type type, string name, Func<IObjectPayloadPool> insteadOfFactory)
