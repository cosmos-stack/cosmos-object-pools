...
namespace Cosmos.Disposables.ObjectPools
{
    ...
    public static partial class ObjectPoolManager
    {
        ...
        public static class Managed<TManagedModel> where TManagedModel : class, IObjectPoolManagedModel, new()
        {
            ...
            public static IObjectPayloadPool<T> Get<T>() => ManagedModels.Get<T, TManagedModel>();
            ...
            // ReSharper disable once MemberHidesStaticFromOuterClass
            public static IObjectPayloadPool<T> Get<T>(string name) => ManagedModels.Get<T, TManagedModel>(name);
