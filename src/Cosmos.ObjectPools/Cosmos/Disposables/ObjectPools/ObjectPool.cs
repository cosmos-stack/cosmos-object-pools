...
namespace Cosmos.Disposables.ObjectPools
{
    ...
    public class ObjectPool<T> : IObjectPool<T>
    {
        ...
        public ObjectPool(int poolSize, Func<T> createObject, Action<Object<T>> onGetObject = null)
            : this(new DefaultPolicy<T> {PoolSize = poolSize, CreateObject = createObject, OnGetObject = onGetObject}) { }
        ...
        private Object<T> GetOrCreateFreeObject(bool checkAvailable)
        {
